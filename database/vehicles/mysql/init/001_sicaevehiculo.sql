...
CREATE TABLE `vehiculo`  (
  ...
  `tiempoCreacion` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `tiempoActualizacion` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
